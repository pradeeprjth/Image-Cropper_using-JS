...
<body>
  ...
  <header class="navbar navbar-light navbar-expand-md">
    <div class="container">
      <a class="navbar-brand" href="./">Wz-image-crop</a>
    </div>
  </header>
  ...
  <div class="container">
      ...
      <div class="col-md-9">
        ...
        <div class="docs-demo">
          <div class="img-container">
            <img src="{{asset('images/picture.jpg')}}" alt="Picture">
          </div>
        </div>
      </div>
      <div class="col-md-3">
    ...
    <div class="row" id="actions">
      <div class="col-md-9 docs-buttons">
        ...
        <label class="btn btn-primary btn-block btn-upload" for="inputImage" title="Upload image file">
